...
#   python 3.6+
#   tensorflow r1.13+
# Extend the normalization with instance normalization and 
# layer normalization.
...
class InstanceNormalization(Layer):
    ...
    This layer is borrorwed from
        https://github.com/keras-team/keras-contrib/blob/master/
    ...
    Arguments:
        axis: Integer, the axis that should be normalized
            ...
            set `axis=1` in `InstanceNormalization` (Instance Normalization).
...
class GroupNormalization(Layer):
    ...
    This layer is borrorwed from
        https://github.com/keras-team/keras-contrib/blob/master/
                keras_contrib/layers/normalization/groupnormalization.py
    ...
    def call(self, inputs, **kwargs):
        ...
        mean, variance = nn_impl.moments(inputs, group_reduction_axes[2:], shift=None, keep_dims=True)
